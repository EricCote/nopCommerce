...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        ...
        {
            viewLocations = new[] { $"/Plugins/Ecomzen.Gifts/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
        else
        {
            viewLocations = new[] { $"/Plugins/Ecomzen.Gifts/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
